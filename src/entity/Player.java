...
public class Player extends Entity{
    ...
    public void setItems(){
        ...
        inventory.add(new DLC_Sword_Flame(gp));
    ...
    public void update() {
        ...
        if(attacking == true){
            ...
            int checkEntity = gp.cChecker.checkEntity(this, gp.iTile);
    ...
    public void attacking(){
        ...
        if(spriteCounter > 5 && spriteCounter <= 25){
            ...
            int checkEntity = gp.cChecker.checkEntity(this, gp.iTile);
            damageInteractiveTile(checkEntity);

            //After checking collision with the updated worldX, worldY and solidArea
